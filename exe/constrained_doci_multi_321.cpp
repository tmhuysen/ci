...
int main() {
    std::ofstream outfile ("co_multi_321.cdoci");
    ...
    libwint::AOBasis ao_basis (CO, "3-21G");
    ...
    outfile <<std::endl<<" repulsion " << CO.calculateInternuclearRepulsionEnergy()<< " doci multiplier : "<<" equal to rhfc multiplier";
    outfile.close();
}
