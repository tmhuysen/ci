...
BOOST_AUTO_TEST_CASE ( DOCI_h2_sto3g_dense_vs_Davidson ) {
    ...
    // Prepare an SOMullikenBasis from an RHF calculation
    ...
    libwint::SOMullikenBasis so_basis (ao_basis, coefficient_matrix);
...
//    libwint::SOMullikenBasis so_basis ("../tests/reference_data/h2o_sto3g_klaas.FCIDUMP", 7);  // 7 SOs
...
//
//    // Do a DOCI calculation based on a given FCIDUMP file
//    libwint::SOMullikenBasis so_basis ("../tests/reference_data/n2_sto-3g_klaas.FCIDUMP", 10);  // 10 SOs
...
//
//    // Do a DOCI calculation based on a given FCIDUMP file
//    libwint::SOMullikenBasis so_basis ("../tests/reference_data/li2_321g_klaas.FCIDUMP", 18);  // 18 SOs
...
//
//    // Do a DOCI calculation based on a given FCIDUMP file
//    libwint::SOMullikenBasis so_basis ("../tests/reference_data/h2o_631g_klaas.FCIDUMP", 13);  // 13 SOs
//    ci::DOCI doci (so_basis, 10);  // 10 electrons
//    doci.solve(numopt::eigenproblem::SolverType::DAVIDSON);
//
//
...
//
//    // Do a DOCI calculation based on a given FCIDUMP file
//    libwint::SOMullikenBasis so_basis ("../tests/reference_data/lif_631g_klaas.FCIDUMP", 28);  // 28 SOs
...
//
//    // Do a DOCI calculation based on a given FCIDUMP file
//    libwint::SOMullikenBasis so_basis ("../tests/reference_data/co_631g_klaas.FCIDUMP", 28);  // 28 SOs
